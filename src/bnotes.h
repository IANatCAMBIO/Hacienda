/* ===========================================================================
 * bnotes.h — Records integration for Lists
 *
 * Lists can show the companion Records app's action items ('!'
 * lines) as a special read/write list.  ALL access goes through the
 * records CLI ("action list" / "action done|undone" / "action due"),
 * never the Records database file: Records' GUI/CLI coexistence is a
...
/* ---------------------------------------------------------------------------
 * bt_bnotes_actions() — run `records action list` and parse the rows
 * (list order preserved: newest note first, like Records prints it).
...
/* ---------------------------------------------------------------------------
 * bt_bnotes_action_set_done() — run `records action done|undone REF`.
...
/* ---------------------------------------------------------------------------
 * bt_bnotes_action_set_due() — run `records action due REF DATE|-`
